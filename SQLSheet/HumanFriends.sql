...
VALUES
("Сфинкс", 3000, "1111-11-11", "Задать загадку"),
("Пантера", 2, "2022-02-21", "Охотиться" ),
("Кошак ГАлактуса",5000, "0000-07-22", "Скушать планету");
## SELECT * FROM Cat;
...
("Цербер", 2000, "0000-01-01", "Охранять вход в царство мертвых"),
...
("Птерадактель", 64002023, "0001-01-01", "Как в парке юрского периода"), 
("Жар Птица", 223, "1800-01-01", "Помогать Ивану Царевичу во всякой фигне");
...
("Росинант", 20, "1605-01-01", "Превозмогать, Дон Кихот");
## SELECT * FROM Horse;
